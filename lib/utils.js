 ...
 * @returns
 */
function taskSourceVal(src, oper, env) {
 ...
 * @returns
 */
function taskStringVal(name, oper, env) {
...
function convertOper(decor) {
    ...
    decor = decor || {};
    if (decor.watch) {
        decor.oper = (decor.oper || def) | TaskConfig_1.Operation.watch;
    }
    if (decor.e2e) {
        decor.oper = (decor.oper || def) | TaskConfig_1.Operation.e2e;
    }
    if (decor.test) {
        decor.oper = (decor.oper || def) | TaskConfig_1.Operation.test;
    }
